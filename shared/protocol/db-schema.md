...
## 6. Histórico de salud de radio (`node_health`, 2026-07-29)

Persiste la trama NODE_HEALTH (`frame-format.md` §16) que el gateway publica en `modulinkr/v1/{node_id}/health`. Motiva la tabla el incidente del 2026-07-27 y 2026-07-28: un nodo que se recupera solo borra la prueba de que algo iba mal, y sin histórico no hay forma de saber si un despliegue se degrada con el tiempo.
